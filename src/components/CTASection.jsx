  ...
  return (
    <section className="py-20 bg-navy-950 border-t border-slate-800/80">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 rounded-2xl bg-slate-900/80 border border-slate-800 text-center">
          ...
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl text-white tracking-tight leading-tight max-w-xl mx-auto">
            Start Your AI Journey
          </h2>

          <p className="text-slate-300 text-base mt-3 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-medium text-slate-200 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-medium text-emerald-300 bg-emerald-950/50 hover:bg-emerald-900/50 border border-emerald-800/50 transition-colors"
            >
          ...
          <div className="pt-6 text-xs text-slate-400 flex items-center justify-center gap-5">
