  ...
  return (
    <section className="py-20 bg-slate-900/30 border-b border-slate-800/80 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-5 sm:p-10 lg:p-12 rounded-2xl bg-slate-900/70 border border-slate-800 shadow-md">
            ...
            <div className="lg:col-span-8 space-y-5">
              ...
              <div className="space-y-2.5 pt-1">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-slate-200 font-medium text-xs sm:text-base">
              ...
              {/* CTAs: Responsive Button Stacking */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 pt-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-medium text-emerald-300 bg-emerald-950/40 hover:bg-emerald-900/40 border border-emerald-800/50 transition-colors w-full sm:w-auto text-center"
                >
